...
void main() {
  ...
  group('fromJson', () {
     ...
     test('should return a valid model when json number is int', 
     () async {
        // arrange
        final Map<String, dynamic> jsonMap = jsonDecode(fixtureReader('trivia.json'));
        // act
     ...
     () async {
        // arrange
        final Map<String, dynamic> jsonMap = jsonDecode(fixtureReader('trivia_double.json'));
        // act
        final result = NumberTriviaModel.fromJson(jsonMap);
        // assert
        expect(result, tNumberTriviaModel);
